<template>
    <div class="flex flex-col md:flex-row items-center md:items-start mb-8">
      <img :src="pokemonImage" :alt="pokemon.name" class="w-72 h-72 object-contain mb-4 md:mb-0 md:mr-8">
      <div class="text-center md:text-left">
        <h2 class="text-4xl font-press-start capitalize mb-2">{{ pokemon.name }}</h2>
        <p class="text-2xl text-gray-500 mb-4 font-press-start">#{{ pokemon.id.toString().padStart(3, '0') }}</p>
