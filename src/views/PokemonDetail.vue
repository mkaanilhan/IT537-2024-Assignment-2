...
div(class="flex flex-col justify-center items-center p-10 h-[calc(100vh-130px)]")
  div(class="bg-white bg-opacity-25 p-5 w-full md:w-[400px] h-min-[500px] rounded-lg flex flex-col items-center hover:bg-gray-300 transition duration-300 ease-in-out")
